...
public class ArtistsController : ControllerBase
{
    private static List<Artists> artists = new List<Artists>{
        ...
        new Artists {Id = 2, Name = "Daft Punk", IsDuo = true, Members = "Thomas Bangalter & Guy-Manuel de Homem-Christo", YearStarted = 1993, Genres = new List<string> {"French house, electronic, dance, disco"}},
